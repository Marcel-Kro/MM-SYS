...
console.log(teams.flat(Infinity).includes('Min'));      // Ist das Element 'Min' im Array vorhanden? - Gibt Bool zurück 
console.log(
...
// Mehrdimensionales Array, also teams[x][y]

// Index des Elements mit dem Wert 'Giulia':
console.log(                                                                
...
// Array mit dem Wert 'Giulia'
console.log(teams[teams.findIndex(x=>x.includes('Giulia'))]);

// Gibt den Wert des Arrays mit Index [2][1] aus
console.log(
    teams
    [teams.findIndex(x=>x.includes('Giulia'))]      // [2]
    [teams[teams.findIndex(x=>x.includes('Giulia'))].indexOf('Giulia')]     // [1]
);
console.log();
...
console.log(
    (teams.map(function(revTeam){
        return revTeam.reverse()        // Jedes untergeordnete Array wird umgedreht
